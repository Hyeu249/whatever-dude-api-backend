...
function initRelation({ Items, ItemsColorsRelations, OrdersAndRelatedInfos }) {
  Colors.belongsToMany(Items, {
    through: ItemsColorsRelations,
    foreignKey: {
      name: "color_id",
      allowNull: false,
    },
  });
  Colors.hasMany(OrdersAndRelatedInfos);
}
