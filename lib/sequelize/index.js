...
function createSchema(sequelizeDb) {
  try {
    ...
    ordersItemsRelations.relation.init(models); // paranoid
    itemsTopicsRelations.relation.init(models);
    itemsGendersRelations.relation.init(models);
    itemsColorsRelations.relation.init(models);
    itemsImagesRelations.relation.init(models);
