...
const ordersAndRelatedInfos = require("./ordersAndRelatedInfos");
...
const models = {
  ...
  OrdersAndRelatedInfos: ordersAndRelatedInfos.OrdersAndRelatedInfos,
...
function createSchema(sequelizeDb) {
  try {
    ...
    var [err] = ordersAndRelatedInfos.schema.init(sequelizeDb);
    if (err !== null) {
      throw new Error(err);
    }
    ...
    ordersAndRelatedInfos.relation.init(models);
